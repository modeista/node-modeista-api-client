...
(function() {
  var ActionMethods, ChannelMethods, Client, CommentMethods, StyleEventCommentMethods, StyleEventMethods, StylistMethods, UserMethods, request, _,
  ...
  module.exports = Client = (function() {
    ...
    function Client(endpoint, options) {
      ...
      this.comments = new CommentMethods(this);
      this.styleEventComments = new StyleEventCommentMethods(this);
    }
