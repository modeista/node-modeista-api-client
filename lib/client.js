...
(function() {
  var ChannelMethods, Client, StyleEventMethods, request, _,
  ...
  module.exports = Client = (function() {
    ...
    Client.prototype._reqWithData = function(method, path, params, data, headers, actor, callback) {
      var _this = this;
      if (headers == null) {
        headers = {};
      }
    ...
    Client.prototype.post = function(path, data, actor, callback) {
      return this._reqWithData("POST", path, null, data, null, actor, callback);
    };

    Client.prototype.patch = function(path, data, actor, callback) {
      return this._reqWithData("PATCH", path, null, data, null, actor, callback);
    };

    Client.prototype.put = function(path, data, actor, callback) {
      return this._reqWithData("PUT", path, null, data, null, actor, callback);
    };

    Client.prototype["delete"] = function(path, params, actor, callback) {
      return this._reqWithData("DELETE", path, params, null, null, actor, callback);
    };

    Client.prototype.get = function(path, params, actor, callback) {
      return this._reqWithData("GET", path, params, null, null, actor, callback);
    };
